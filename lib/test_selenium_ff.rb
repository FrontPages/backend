# I created this file, which is not used anywhere in production, to help me test during the transition from Capybara/PhantomJS to Selenium/FirefoxDriver.

require 'selenium-webdriver'

options = Selenium::WebDriver::Firefox::Options.new(args: ['-fullPage true'])
driver = Selenium::WebDriver.for(:firefox, options: options)
driver.navigate.to 'http://washingtonpost.com/'
puts driver.title
